...
// Für file://-Kontext: erst direkt versuchen (Firmennetz-Proxy ergänzt oft CORS-Header),
// bei Netzwerk-Fehler über öffentliche CORS-Proxies als Fallback.
var _CORS_PROXIES = [
  'https://corsproxy.io/?',
...
function _fetchCors(url, options) {
  return fetch(url, options).catch(function() {
    ...
    // Proxies nacheinander probieren
    return _CORS_PROXIES.reduce(function(chain, proxy) {
