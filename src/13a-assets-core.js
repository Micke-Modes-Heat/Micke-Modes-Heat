...
// Simulationsrelevante Props pro Typ (für UI-Formular-Generierung)
export const ASSET_PROPS_SCHEMA = {
  ...
  NSHV:         [{ key:'leistungKVA',        label:'Leistung (kVA)' },
                 { key:'abgaenge',           label:'Abgänge' }],
  UV:           [{ key:'leistungKW',         label:'Durchgangsleistung (kW)' },
  ...
  WP:           [{ key:'leistungKW',         label:'Leistung (kW)' }],
  Nsa:          [{ key:'leistungKW',         label:'Leistung (kW)' },
                 { key:'autonomieH',         label:'Autonomie (h)' }],
  Wind:         [{ key:'leistungKW',         label:'Leistung (kW)' }],
  KWK:          [{ key:'leistungKW_el',      label:'Leistung el. (kW)' },
                 { key:'leistungKW_th',      label:'Leistung th. (kW)' }],
  Reserve:      [],
};
