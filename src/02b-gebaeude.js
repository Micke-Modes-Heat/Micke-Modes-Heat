...
export function getSizeRange(){ return getRange(gebaeude.map(g=>getSizeVal(g)).filter(v=>v!==null)); }
export function getColorRange(){ return getRange(gebaeude.map(g=>getColorVal(g)).filter(v=>v!==null)); }
