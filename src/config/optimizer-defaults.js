...
// EE-Erzeuger (Wärme)
export const OPT_EE_KEYS = ['lwwp', 'fg', 'geo', 'pellets', 'hhs', 'solarthermie'];

// Merit-Order-Sortierung: Grundlast zuerst (WP, BHKW, Biomasse), dann Kessel/Spitzenlast
export const OPT_MERIT_ORDER = ['bhkw', 'geo', 'fg', 'lwwp', 'pellets', 'hhs', 'stromkessel', 'fernwaerme', 'gaskessel', 'heizoel'];
