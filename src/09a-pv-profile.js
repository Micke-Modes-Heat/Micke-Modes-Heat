...
// ── Strom-Lastgang-Upload ─────────────────────────────────────────────────
// Gemessene Lastgänge verwaltet 23-messjahre-panel.js (⚡ Strom-Grundlagen › Messjahre).
// Dieser Einstieg bleibt für den Upload in der PV-Analyse: die Datei wird ein Messjahr und
// gleich Referenzjahr, weil sie dort bewusst für die Rechnung gewählt wurde.
export function stromFileSelected(file) {
  if (file && typeof window.sgMjDateiAlsReferenz === 'function') window.sgMjDateiAlsReferenz(file);
}
